...
class Setup_file_category extends Root_Controller
{
    ...
    private function system_edit($id)
    {
        if(isset($this->permissions['action2']) && ($this->permissions['action2']==1))
        {
            ...
            {
                $file_category_id=$this->input->post('id');
            }
            else
            {
                $file_category_id=$id;
            ...
            $data['file_category']=Query_helper::get_info($this->config->item('table_setup_file_category'),'*',array('id ='.$file_category_id),1);
            $data['title']="Edit File Category (".$data['file_category']['name'].')';
            $ajax['status']=true;
            $ajax['system_content'][]=array('id'=>'#system_content','html'=>$this->load->view($this->controller_url.'/add_edit',$data,true));
            if($this->message)
            {
            ...
            $ajax['system_page_url']=site_url($this->controller_url.'/index/edit/'.$file_category_id);
            $this->jsonReturn($ajax);
        }
        else
        {
    ...
    private function system_save()
    {
        ...
        {
            $data=$this->input->post('file_category');
    ...
    private function check_validation()
    {
        ...
        $this->form_validation->set_rules('file_category[name]',$this->lang->line('LABEL_NAME'),'required');
