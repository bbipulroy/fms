...
$config['table_fms_setup_file_item']='fms_setup_file_item';
$config['table_fms_setup_file_hc_location']='fms_setup_file_hc_location';
$config['table_fms_setup_assign_file_user_group']='fms_setup_assign_file_user_group';
$config['table_fms_tasks_digital_file']='fms_tasks_digital_file';
