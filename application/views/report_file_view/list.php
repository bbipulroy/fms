        ...
        */?>
        <div class="col-xs-12" style="margin-bottom: 20px;">
            <div class="col-xs-12" style="margin-bottom: 20px;">
                ...
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="date_start"><?php /*echo $CI->lang->line('LABEL_NAME'); */?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="office"><?php /*echo $CI->lang->line('LABEL_DATE_PO'); */?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="department"><?php /*echo $CI->lang->line('LABEL_DATE_RETURNED'); */?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="employee"><?php /*echo $CI->lang->line('LABEL_DIVISION_NAME'); */?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="file_category"><?php /*echo $CI->lang->line('LABEL_ZONE_NAME'); */?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="file_class"><?php /*echo $CI->lang->line('LABEL_TERRITORY_NAME'); */?></label>
                <label class="checkbox-inline"><input type="checkbox" class="system_jqx_column"  checked value="file_type"><?php /*echo $CI->lang->line('LABEL_DISTRICT_NAME'); */?></label>
