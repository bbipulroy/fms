...
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_new_file');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status_file" name="item[status_file]" class="form-control">
                    <option value="<?php echo $CI->config->item('system_status_file_open'); ?>"><?php echo $CI->lang->line('FILE_STATUS_OPEN'); ?></option>
                    <option value="<?php echo $CI->config->item('system_status_file_close'); ?>"><?php echo $CI->lang->line('FILE_STATUS_CLOSE'); ?></option>
                </select>
            </div>
        </div>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[ordering]" id="ordering" class="form-control" value="">
            </div>
        </div>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="item[date_start]" id="date_start" class="form-control datepicker" value="<?php echo System_helper::display_date(time()); ?>">
            </div>
        </div>
