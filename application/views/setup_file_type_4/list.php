    ...
    $(document).ready(function ()
    {
        ...
        var source =
        {
            ...
            dataFields: [
                ...
                { name: 'file_type_2_name', type: 'string' },
                { name: 'file_type_1_name', type: 'string' },
                { name: 'file_type_3_name', type: 'string' },
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_FILE_TYPE_1'); ?>', dataField: 'file_type_1_name',filtertype: 'list',width:'250'},
                    { text: '<?php echo $CI->lang->line('LABEL_FILE_TYPE_2'); ?>', dataField: 'file_type_2_name',filtertype: 'list',width:'250'},
                    { text: '<?php echo $CI->lang->line('LABEL_FILE_TYPE_3'); ?>', dataField: 'file_type_3_name',filtertype: 'list',width:'250'},
